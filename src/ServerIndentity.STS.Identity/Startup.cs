...
using ServerIndentity.STS.Identity.Configuration;
using ServerIndentity.STS.Identity.Configuration.Constants;
using ServerIndentity.STS.Identity.Configuration.Interfaces;
using ServerIndentity.STS.Identity.Helpers;
using System;
using Skoruba.IdentityServer4.Shared.Configuration.Helpers;

namespace ServerIndentity.STS.Identity
{
