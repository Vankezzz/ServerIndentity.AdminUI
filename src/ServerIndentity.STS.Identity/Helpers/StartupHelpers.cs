...
using ServerIndentity.STS.Identity.Configuration.ApplicationParts;
using ServerIndentity.STS.Identity.Configuration.Constants;
using ServerIndentity.STS.Identity.Configuration.Interfaces;
using ServerIndentity.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace ServerIndentity.STS.Identity.Helpers
{
